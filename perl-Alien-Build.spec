...
Source0  : https://cpan.metacpan.org/authors/id/P/PL/PLICEASE/Alien-Build-2.46.tar.gz
...
%prep
%setup -q -n Alien-Build-2.46
cd %{_builddir}/Alien-Build-2.46
...
cp %{_builddir}/Alien-Build-2.46/LICENSE %{buildroot}/usr/share/package-licenses/perl-Alien-Build/6bc96447de752f532034fa64641f08fd5f8b09f2
cp %{_builddir}/Alien-Build-2.46/corpus/cmake-libpalindrome/LICENSE %{buildroot}/usr/share/package-licenses/perl-Alien-Build/f3de9c9b719c6785e72148e6a606dfc96d2d8452
if test -f Makefile.PL; then
