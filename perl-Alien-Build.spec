...
Source0  : https://cpan.metacpan.org/authors/id/P/PL/PLICEASE/Alien-Build-2.12.tar.gz
...
%prep
%setup -q -n Alien-Build-2.12
cd %{_builddir}/Alien-Build-2.12
...
cp %{_builddir}/Alien-Build-2.12/LICENSE %{buildroot}/usr/share/package-licenses/perl-Alien-Build/ac7d4c1528953bc548c475ca81315fa6d07415ee
cp %{_builddir}/Alien-Build-2.12/corpus/cmake-libpalindrome/LICENSE %{buildroot}/usr/share/package-licenses/perl-Alien-Build/f3de9c9b719c6785e72148e6a606dfc96d2d8452
if test -f Makefile.PL; then
...
/usr/lib/perl5/vendor_perl/5.30.1/Alien/Build/Plugin/Probe/Vcpkg.pm
