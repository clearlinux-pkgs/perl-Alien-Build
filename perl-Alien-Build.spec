...
Source0  : https://cpan.metacpan.org/authors/id/P/PL/PLICEASE/Alien-Build-2.42.tar.gz
...
%prep
%setup -q -n Alien-Build-2.42
cd %{_builddir}/Alien-Build-2.42
...
cp %{_builddir}/Alien-Build-2.42/corpus/cmake-libpalindrome/LICENSE %{buildroot}/usr/share/package-licenses/perl-Alien-Build/f3de9c9b719c6785e72148e6a606dfc96d2d8452
if test -f Makefile.PL; then
